...
ANNONCE_CHANNEL_ID = 1345408288618971217
...
@bot.tree.command(name="casino", description="Affiche les boutons de gestion du ROYAL Casino", guild=discord.Object(id=GUILD_ID))
